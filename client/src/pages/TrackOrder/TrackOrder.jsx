      ...
      <div className="bg-gray py-5 border-b-2 border-borderColor px-14">
        <ContainerMax>
          ...
          <form onSubmit={handleSubmit(handleSearch)} className="py-5">
            ...
            <button
              type="submit"
              className="btn bg-[#83B735] text-white py-2 px-4 -ml-2"
            >
              Enter ID
            </button>
          </form>
          <div className="flex justify-between gap-4 font-sans border border-borderColor p-4 rounded-lg">
            <TrackItem
              information_name={"Estimated Delivery time:"}
              information={"24 Nov 2022"}
            />
            <TrackItem
              information_name={"Shipping By:"}
              information={
                <p className="text-heading font-sans text-base">
                  {" "}
                  BLUEDART,| <PhoneEnabledIcon /> +1598759364
                </p>
              }
            />
            <TrackItem
              information_name={"Status:"}
              information={"Picked by the currier"}
            />
            <TrackItem
              information_name={"Tracking#:"}
              information={"BD04535352345"}
            />
          </div>
          ...
          <Link to="/">
            <BackToOrderBtn title={"Back To Order"} />
          </Link>
        </ContainerMax>
      </div>
    </ContainerFull>
